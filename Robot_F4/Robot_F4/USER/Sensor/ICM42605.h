...
#define ICM42605_HW_SPI	0
#define ICM42605_HW_IIC	1
#define ICM42605_SW_IIC	2
struct icm42605
{
	void* hw;
	...
	uint16_t CS_Pin;
#endif
#if defined(ICM_USE_HARD_I2C) | defined(ICM_USE_SOFT_I2C)
	uint8_t I2C_ADDR;
#endif
	uint8_t HW_Type;	//0:硬件SPI，1:硬件IIC，2:软件IIC
